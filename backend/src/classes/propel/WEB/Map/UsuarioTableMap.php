...
class UsuarioTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'WEB.Map.UsuarioTableMap';
     ...
     */
    const OM_CLASS = '\\WEB\\Usuario';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'WEB.Usuario';
    ...
    /**
     * the column name for the usario field
     */
    const COL_USARIO = 'USUARIO.usario';
     ...
     */
    const COL_ISADMIN = 'USUARIO.isAdmin';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Nome', 'Email', 'Telefone', 'Usario', 'Senha', 'Isadmin', ),
        self::TYPE_CAMELNAME     => array('id', 'nome', 'email', 'telefone', 'usario', 'senha', 'isadmin', ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID, UsuarioTableMap::COL_NOME, UsuarioTableMap::COL_EMAIL, UsuarioTableMap::COL_TELEFONE, UsuarioTableMap::COL_USARIO, UsuarioTableMap::COL_SENHA, UsuarioTableMap::COL_ISADMIN, ),
        self::TYPE_FIELDNAME     => array('id', 'nome', 'email', 'telefone', 'usario', 'senha', 'isAdmin', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Nome' => 1, 'Email' => 2, 'Telefone' => 3, 'Usario' => 4, 'Senha' => 5, 'Isadmin' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'nome' => 1, 'email' => 2, 'telefone' => 3, 'usario' => 4, 'senha' => 5, 'isadmin' => 6, ),
        self::TYPE_COLNAME       => array(UsuarioTableMap::COL_ID => 0, UsuarioTableMap::COL_NOME => 1, UsuarioTableMap::COL_EMAIL => 2, UsuarioTableMap::COL_TELEFONE => 3, UsuarioTableMap::COL_USARIO => 4, UsuarioTableMap::COL_SENHA => 5, UsuarioTableMap::COL_ISADMIN => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'nome' => 1, 'email' => 2, 'telefone' => 3, 'usario' => 4, 'senha' => 5, 'isAdmin' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('telefone', 'Telefone', 'VARCHAR', true, 20, null);
        $this->addColumn('usario', 'Usario', 'VARCHAR', true, 255, null);
        $this->addColumn('senha', 'Senha', 'LONGVARCHAR', true, null, null);
        $this->addColumn('isAdmin', 'Isadmin', 'BOOLEAN', true, 1, null);
    } // initialize()
    ...
    {
        $this->addRelation('PedidoSuporteRelatedByIdusuarioCriador', '\\WEB\\PedidoSuporte', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idUsuario_Criador',
    1 => ':id',
  ),
), null, null, 'PedidoSuportesRelatedByIdusuarioCriador', false);
        $this->addRelation('PedidoSuporteRelatedByIdusuarioExecutor', '\\WEB\\PedidoSuporte', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':idUsuario_Executor',
    1 => ':id',
  ),
), null, null, 'PedidoSuportesRelatedByIdusuarioExecutor', false);
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsuarioTableMap::COL_USARIO);
            $criteria->addSelectColumn(UsuarioTableMap::COL_SENHA);
            $criteria->addSelectColumn(UsuarioTableMap::COL_ISADMIN);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.nome');
            $criteria->addSelectColumn($alias . '.email');
            $criteria->addSelectColumn($alias . '.telefone');
            $criteria->addSelectColumn($alias . '.usario');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \WEB\Usuario) { // it's a model object
